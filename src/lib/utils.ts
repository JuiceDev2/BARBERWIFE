...
// ── Flujo de validación de Servicios Especiales (estado_cita) ──
export const ESTADO_CITA_FLUJO_LABELS: Record<string, string> = {
...
export const ESTADO_CITA_FLUJO_COLORS: Record<string, string> = {
  pendiente_validacion: 'bg-yellow-100 text-yellow-800',
  pendiente_anticipo:   'bg-orange-100 text-orange-800',
  confirmada:           'bg-blue-100 text-blue-800',
