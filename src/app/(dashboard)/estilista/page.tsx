...
export default async function EstilistaPage() {
  ...
  // Verificar turno activo (El turno único del día para todo el salón)
  ...
  const { data: citas } = await supabase
    .from('citas')
    .select('*, cliente:clientes(*), servicio:servicios(*), municipio:municipios(nombre)')
    .eq('salon_id', salonId)
    ...
    <div>
      ...
      <div className="p-4 sm:p-6 md:p-8">
        <CitasEstilista
          ...
          turnoActivo={!!turno}
          turnoId={turno?.id} // ✅ CAMBIO: Pasamos el ID del turno activo
