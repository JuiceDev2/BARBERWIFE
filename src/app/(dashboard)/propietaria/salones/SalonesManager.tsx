  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        {showSalon && (
          <form onSubmit={crearSalon} className="card grid grid-cols-1 sm:grid-cols-3 gap-4 items-end mb-4">
            <div>
      ...
      <div>
        ...
        {showAdmin && (
          <form onSubmit={crearAdmin} className="card grid grid-cols-1 sm:grid-cols-2 gap-4 items-end mb-4">
            <div>
              <label className="label">Nombre *</label>
